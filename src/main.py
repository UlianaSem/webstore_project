...
<main>
    ...
    <div class="container">
        ...
        <main class="row">
            ...
            <div class="row text-center">
                <p>
                    <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample1" aria-expanded="false" aria-controls="multiCollapseExample1">Как купить?</button>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="collapse multi-collapse" id="multiCollapseExample2">
                            <div class="card card-body">
                                У нас нет доставки, заберите самостоятельно
                            </div>
                        </div>
                    </div>
                    <div class="col">
